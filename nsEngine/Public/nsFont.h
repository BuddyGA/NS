...
public:
	...
	static NS_ENGINE_API void GenerateVertices(nsFontID font, nsPointFloat& position, const char* text, int length, const nsColor& color, nsTArray<nsVertexGUI>& outVertices, nsTArray<uint32>& outIndices);
